namespace KinectProject.ViewModels
{
    ...
    using KinectProject.Navigation;
    ...
    public class VideoViewModel : ViewModelBase
    {
        ...
        /// <summary>
        /// Recognize voice commands and excute relevant functions
        /// Vioce Commands:
        /// 1. Play: play vedio
        /// 2. Pause: pause vedio
        /// 3. Resume: resume vedio
        /// 4. Back: go back to homescreen
        /// </summary>
        /// <param name="sender">object</param>
        /// <param name="e">SpeechRecognizedEventArgs</param>
        private new void OnVoiceCommands(object sender, SpeechRecognizedEventArgs e)
        {
